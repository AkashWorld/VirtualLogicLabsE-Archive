...
/// output is set.
/// </summary>
public class XORGate : MonoBehaviour, LogicInterface
{
    ...
    public const string LOGIC_DEVICE_ID = "74LS86A_XOR_NODE_";
    ...
    private void ChipIO()
    {
        ...
        if (logic_dictionary.TryGetValue(LOGIC_DEVICE_ID + 6, out logic_6))
        {
            ...
            if (collided_state != (int)LOGIC.LOW)
            {
                ...
                Debug.Log("XOR 74LS86A Ground Input not set to LOW");
            }
        ...
        if (logic_dictionary.TryGetValue(LOGIC_DEVICE_ID + 13, out logic_13))
        {
            ...
            {
                logic_behavior.SetLogicState((int)LOGIC.INVALID);
                Debug.Log("XOR 74LS86A VCC Input not set to HIGH");
            }
        ...
        if (logic_dictionary.TryGetValue(LOGIC_DEVICE_ID + 0, out logic_0))
        {
            ...
            {
                logic_behavior.SetLogicState((int)LOGIC.INVALID);
                Debug.Log("XOR 74LS86A input 0 is invalid.");
            }
